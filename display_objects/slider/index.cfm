...
<cfoutput>
	...
	<cfelse>
		...
		<script>
			Mura(function(m) { 
				m.loader() 
					.loadcss('#local.pluginPath#/assets/nivo-slider/nivo-slider.css') 
					.loadcss('#local.pluginPath#/assets/nivo-slider/themes/#objectparams.theme#/#objectparams.theme#.css')
					.loadjs(
						'#local.pluginPath#/assets/nivo-slider/jquery.nivo.slider.pack.js',
						function() {
